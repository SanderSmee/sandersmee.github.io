...
hexo.extend.tag.register('posts_in_same_series', function (args) {
    ...
    var postSeriesHtmlSegments = ['<div class="sidebarblock post-series">', '<div class="content">'];
    if (config.list_title) {
        postSeriesHtmlSegments = postSeriesHtmlSegments.concat([ '<div class="title">', config.list_title.replace('@series@', postInfo.series), '</div>' ]);
    }
    ...
    postSeriesHtmlSegments.push('</ul></div></div>');
